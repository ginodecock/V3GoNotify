...
uint8_t esp1[] = {0x1A, 0xFE, 0x34, 0xA2, 0x36, 0x6B};
...
void setup() {
  ...
  //int res2 = esp_now_add_peer(esp2, (uint8_t)ESP_NOW_ROLE_SLAVE, WIFI_DEFAULT_CHANNEL, NULL, 0);
  //int res3 = esp_now_add_peer(esp3, (uint8_t)ESP_NOW_ROLE_SLAVE, WIFI_DEFAULT_CHANNEL, NULL, 0);
  //int res4 = esp_now_add_peer(esp4, (uint8_t)ESP_NOW_ROLE_SLAVE, WIFI_DEFAULT_CHANNEL, NULL, 0);
  //int res5 = esp_now_add_peer(espdev, (uint8_t)ESP_NOW_ROLE_SLAVE, WIFI_DEFAULT_CHANNEL, NULL, 0);
}
